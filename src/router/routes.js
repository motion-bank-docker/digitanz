...
const routes = [
  users,
  {
    ...
    children: [
      ...
      { path: 'mr-griddle/create', component: () => import('pages/mr-griddle'), meta: {private: true} },
      { path: 'mr-griddle/:uuid/edit', component: () => import('pages/mr-griddle'), meta: {private: true} },
      { path: 'mr-griddles', component: () => import('pages/mr-griddles'), meta: {private: true} },
